export const demoRequests = [
  ...
  { id:"ATRY-2026-00122", created_at:"2026-09-16T18:30:00", customer_name:"Joaquín Pérez", customer_company:"Liga Sur", customer_phone:"092 704 618", title:"Trofeos campeonato", category:"Eventos", quantity:12, deadline:"30 set", status:"quoted", priority:"high", amount:18400, notes:"Tres tamaños con nombre de categoría." },
...
export const statusMeta = {
  new:{label:"Nueva",tone:"blue"}, reviewing:{label:"Revisando",tone:"violet"}, quoted:{label:"Cotizada",tone:"amber"},
